...
export const projects: Project[] = [
  {
    ...
    descRu: "Крытый бассейн с синей мозаикой и системой аэромассажа. Гидромассажные форсунки по периметру, нержавеющая лестница, глубина 1,5 м, тёплая вода круглый год.",
    descKg: "Көк мозаикалуу жабык бассейн, аэромассаж тутуму, тот баспас тепкич, тереңдиги 1,5 м. Жылы суу жыл бою.",
    term: "40 дней",
    year: 2025,
  },
  {
